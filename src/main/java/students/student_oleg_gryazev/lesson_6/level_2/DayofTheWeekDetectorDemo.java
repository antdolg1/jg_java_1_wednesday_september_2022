package students.student_oleg_gryazev.lesson_6.level_2;
...
class DayOfTheWeekDetector {
    ...
    public String findDayOfTheWeek(int dayNumber) {
        ...
        switch (dayNumber) {
            case 1 -> day = "Monday"; //System.out.println("Monday");
            case 2 -> day = "Tuesday";
        ...
        return (day);// реализуйте данный метод !
    }
    }
...
class DayOfTheWeekDetectorTest {
    ...
    public void shouldReturnSaturday() {
        ...
        checkTestResult("Saturday".equals(dayOfTheWeek), "Satrurday");
    }
