...
public class ArrayThreeNumbersRandomAverage {
    public static void main(String[] args) {
        ...
        int averageNumbers = (numbers[0] + numbers[1] + numbers[2]) / 3;
        ...
        System.out.println("Arithmetic mean of all elements in numbers[] is: " + averageNumbers);
